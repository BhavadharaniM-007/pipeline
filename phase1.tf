...
resource "aws_instance" "web_server" {
  ...
  tags = {
    Name = "TerraformWebServer-098457"
  }
}
...
resource "aws_dynamodb_table" "tf_lock_table" {
  name         = "terraformlocks1234-123456787"
